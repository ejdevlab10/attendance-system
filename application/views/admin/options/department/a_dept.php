        ...
        <div class="container-fluid">
          ...
          <a href="<?= base_url('Admin_controller/view_departments'); ?>" class="btn btn-secondary btn-icon-split mb-4">
            <span class="icon text-white">
              <i class="fas fa-chevron-left"></i>
            </span>
            <span class="text">Back</span>
          </a>
          <form action="<?= base_url();?>store_dep" method="POST" class="col-lg-5  p-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form>
                  <div class="form-group">
                    <label for="id" class="col-form-label-lg">Department ID</label>
                    <input type="text" class="form-control form-control-lg" name="id" id="id">
                    <?= form_error('id', '<small class="text-danger">', '</small>') ?>
                  </div>
                  <div class="form-group">
                    <label for="name" class="col-form-label-lg">Department Name</label>
