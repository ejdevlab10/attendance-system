           ...
           <div class="col-xl-3 col-md-6 mb-4">
             <div class="card border-left-warning shadow h-100 py-2">
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Strand & Course</div>
                     <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $display['c_course']; ?> Strand / Course</div>
                   </div>
                   <div class="col-auto">
                     <i class="fas fa-building fa-2x text-gray-600"></i>
                   </div>
             ...
             <div class="card border-left-primary shadow h-100 py-2">
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   ...
                   <div class="col-auto">
                     <i class="fas fa-id-badge fa-2x text-gray-600"></i>
                   </div>
                 </div>
               </div>
             </div>
               ...
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     ...
                     <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $display['c_student']; ?> Students</div>
                   </div>
                   <div class="col-auto">
                     <i class="fas fa-graduation-cap fa-2x text-gray-600"></i>
                   </div>
                 </div>
               </div>
             </div>
        ...
        <div class="row">
             ...
             <div class="col p-0">
               <div class="card shadow mb-4">
                 <div class="card-header py-3 d-flex flex-rowz align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-primary">Employee Departments' </h6>
           ...
           <div class="col-xl-4 col-lg-5">
             <div class="col p-0">
               <div class="card shadow mb-4">
                 <div class="card-header py-3 d-flex flex-rowz align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-primary">Course's and Strands </h6>
                   <div class="dropdown no-arrow">
                     <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                       <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                     </a>
                     <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                       <div class="dropdown-header">More Details:</div>
                       <a class="dropdown-item" href="admin">Course List</a>
                     </div>
                   </div>
                 </div>
                 <div class="card-body" style="max-height: 400px; overflow: scroll; overflow-x : hidden;">
