<div class="container-fluid">
  ...
  <div class="col-lg-10 p-0">
    <?= form_open_multipart('Student_controller/add_student'); ?>
    <div class="card">
      <h5 class="card-header">Employee Master Data</h5>
      <div class="card-body">
        <h5 class="card-title">Add New Employee</h5>
        <p class="card-text">Form to add new student to the system</p>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <!-- Enrolled Date -->
            <div class="form-group row mb-3">
              <label for="e_enrolled_date" class="col-form-label col-lg-4">Enrolledd Date</label>
              <div class="col-lg-8 p-0">
                <input type="date" class="form-control" name="e_enrolled_date" id="e_enrolled_date" min="2000-01-01" max="<?= date('Y-m-d'); ?>">
